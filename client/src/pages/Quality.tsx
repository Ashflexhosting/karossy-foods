...
export default function Quality() {
  return <div className="app-shell page-shell"><SiteHeader /><main><PageLead eyebrow="Quality & sourcing" title={<>Quality starts at the source.</>} description="Karossy Foods focuses on sourcing authentic Nigerian and African food products through suitable suppliers and producers." bannerImage="/manus-storage/karossy-botanical-detail_d9ef6275.jpg" bannerPosition="center" bannerVariant="quality" />

...
export const productCategories: ProductCategory[] = [
  ...
  { slug: "dried-packaged-snails", name: "Dried & packaged Nigerian snails", label: "Nigerian snail", summary: "Dried and packaged snails from Nigeria for African food retail, wholesale and specialist buyer enquiries.", buyerFocus: "For buyers seeking Nigerian snail products in dried and packaged formats for defined market, quantity and handling requirements.", routeNote: "Nigerian dried snail sourcing", items: ["Dried Nigerian snails", "Packaged snail products"], className: "assortment-fruit", image: "/manus-storage/dried-snail_72b85033.jpg", imageAlt: "Dried Nigerian snails arranged for food product selection" },
